...
<link rel="stylesheet" type="text/css" href="/login.css?z10">
<title>NETGEAR GS305E</title>
<script src="/jquery.md5.js?z10" type="text/javascript"></script>
<script src="/login.js?z10" type="text/javascript"></script>
...
<div id="mainArea" class="mainArea">
  <div id="mainTitleArea" class="mainTitleArea">
   ...
   <div class="switchInfo">GS305E &ndash; 5-Port Gigabit Ethernet Smart Managed Plus Switch</div>
  </div>
...
<div id="pwdErr" class="pwdErrStyle"></div>
       ...
       <input type=hidden id='rand' value='1018767543' disabled>     </form>
   </div>
         <div class="footerImg">
