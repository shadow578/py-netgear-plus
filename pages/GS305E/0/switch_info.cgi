...
<tr><td class="paddingTableBody" colspan='2'><table class="tableStyle" id="tbl2" style="width:728px;">
 <tr>
  ...
  <td align="center" nowrap>GS305E</td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td  align="center" nowrap>5W164658A0D0C</td>
 </tr>
 <tr>
  <td class="padding14Top">MAC Address</td>
  <td  align="center" nowrap>54:07:7D:1B:18:2F</td>
 </tr>
 <tr>
  <td class="padding14Top">Bootloader Version</td>
  <td  align="center" nowrap>V1.0.0.2</td>
 </tr>
 <tr>
  <td class="padding14Top">Firmware Version</td>
  <td  align="center" nowrap>V1.0.0.16</td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td  align="center" nowrap>
  <input type="text" name="ip_address" id="ip_address" value="10.37.91.2" size="15" maxlength="15" onmousedown="enableImage();" onkeypress="enableImage();">
  </td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td  align="center" nowrap>
  <input type="text" name="gateway_address" id="gateway_address" value="10.37.91.1" size="15" maxlength="15" onmousedown="enableImage();" onkeypress="enableImage();">
  </td>
 </tr>
