...
<div id="switch_name" untrans>GS308EP</div>
</div>
</div>
...
<input type="hidden" id="prctName" value="GS308EP" />
</div>
<div class="hid_info_cell col-xs-12 col-sm-6">
<div class="hid_info_title"><span>ml656</span></div>
<div><span>
<input id="switchName" name='switch_name' class="input-theme" style="width:130%;color:#fff;" oninput="enableButtons()" maxlength="20" role="input" value="GS308EP" type="text">
</span></div></div>
<div class="hid_info_cell col-xs-12 col-sm-6">
...
<span class="">192.168.178.30</span></span>
</div></div>
...
<span style='text-overflow:ellipsis;overflow:hidden;white-space:nowrap;width:90%;display:inline-block;'>1 - wax610b </span></span></div>
...
<span style='text-overflow:ellipsis;overflow:hidden;white-space:nowrap;width:90%;display:inline-block;'>2 - wax610a </span></span></div>
...
<span style='text-overflow:ellipsis;overflow:hidden;white-space:nowrap;width:90%;display:inline-block;'>3 - loki </span></span></div>
...
<span style='text-overflow:ellipsis;overflow:hidden;white-space:nowrap;width:90%;display:inline-block;'>4 - homeassistant </span></span></div>
...
<span style='text-overflow:ellipsis;overflow:hidden;white-space:nowrap;width:90%;display:inline-block;'>8 - upstream </span></span></div>
