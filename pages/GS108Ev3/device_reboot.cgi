    ...
    <script language="JavaScript">
      function doReload() {
        ...
        if (url.indexOf("/device_reboot.cgi") != -1) {
          top.location.href = url.substring(
            0,
            url.lastIndexOf("/device_reboot.cgi")
          );
        } else {
  ...
  <body>
      ...
      <tr>
        <td>
          <table class="tableStyle">
            <tr>
              <script>
                tbhdr("Device Reboot", "deviceReboot");
              </script>
            </tr>
            <tr>
              <td class="topTitleBottomBar" colspan="2"></td>
            </tr>
            <tr>
              <td class="paddingsubSectionBodyNone" colspan="2">
                <table class="tableStyle" style="width: 745px">
                  <tr>
                    <td colspan="2">
                      Check box and click Apply button to reboot switch.
                      <input
                        type="checkbox"
                        name="CBox"
                        id="CBox"
    ...
    <script>
      ...
      popUpWindown(
        "alert",
        "Device Reboot",
        "The device is restarting. Wait until the process is complete.",
        true
      );
      reloadAll();
    </script>
