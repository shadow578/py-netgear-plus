...
<span class="p-name">GS308EPP</span>
    </div>
    <div class="summary">
...
<input type=hidden id='acptLang' value='en' disabled><input type=hidden id='rand' value='1425622205' disabled><div class="signin-button" style='cursor:pointer;'>
