...
<tr><td class="paddingTableBody" colspan='2'><table class="tableStyle" id="tbl2" style="width:728px;">
 <tr>
  ...
  <td align="center" nowrap>GS105Ev2</td>
 </tr>
 <tr>
  <td class="padding14Top">Switch Name</td>
  <td  align="center" nowrap>
  <input type="text" name="switch_name" id="switch_name" value="Switch01" size="15" maxlength="20" onmousedown="enableImage();" onkeypress="enableImage();" />
 </td></tr>
 <tr>
  <td class="padding14Top">Serial Number</td>
  <td  align="center" nowrap>3MX8785Y02A60</td>
 </tr>
 <tr>
  <td class="padding14Top">MAC Address</td>
  <td  align="center" nowrap>B0:39:56:8F:47:4A</td>
 </tr>
 <tr>
  <td class="padding14Top">Bootloader Version</td>
  <td  align="center" nowrap>V1.4.0.5-VB</td>
 </tr>
 <tr>
  <td class="padding14Top">Firmware Version</td>
  <td  align="center" nowrap>V1.6.0.15</td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td  align="center" nowrap>
  <input type="text" name="ip_address" id="ip_address" value="10.0.1.106" size="15" maxlength="15" onmousedown="enableImage();" onkeypress="enableImage();">
  </td>
 </tr>
 <tr>
